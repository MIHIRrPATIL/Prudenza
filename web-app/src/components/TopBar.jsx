...
export default function TopBar({ children }) {
  return (
    <header className="border rounded-4xl text-white/70 p-3 border-white/40">
      ...
      <div className="w-full">
        <div className="flex justify-between gap-8 sm:flex-row flex-col">
          ...
          <div className="relative">
            <DotPattern/>
            <p className={`${overview >= 0 ? "text-green-400" : "text-red-400"} absolute inset-0 flex items-center justify-center font-semibold `}>
              {overview}
            </p>
          </div>
        </div>
